...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col">
				<label for="nombre">RUT del Cliente</label>
				<input type="text" class="form-control" value="${solicitudIngresada.cliente.rut}" readonly="readonly">
			</div>
		</div>
		...
		<div class="row">
			<div class="col">
				...
				<input type="text" class="form-control" value="${solicitudIngresada.cliente.nombre}" readonly="readonly">
			</div>
		</div>
		<div class="row">
			<div class="col">
				<label for="apellido">Apellido del Cliente</label>
				<input type="text" class="form-control" value="${solicitudIngresada.cliente.apellido}" readonly="readonly">
			</div>
		</div>
		<div class="row">
			<div class="col">
				<label for="fecInstalacion">Fecha de Instalación</label>
				<input type="text" class="form-control" value="${solicitudIngresada.fechaInstalacion}" readonly="readonly">
			</div>
		</div>
		<div class="row">
			<div class="col">
					...
					<table class="table table-bordered table-hover table-sm">
						...
						<tbody>
							<c:if test="${solicitudIngresada.telefoniaHogar != null}">
								<tr>
									<td>Telefonía Hogar: ${solicitudIngresada.telefoniaHogar.nombre}</td>
									<td>
										<c:choose>
											<c:when test="${solicitudIngresada.telefoniaHogar.esIlimitado}">∞</c:when>
											<c:otherwise><c:out value="${solicitudIngresada.telefoniaHogar.minutos}" /></c:otherwise>
										</c:choose> minutos
									</td>
							...
							<c:if test="${solicitudIngresada.televisionHogar != null}">
								<tr>
									<td>Televisión Hogar: ${solicitudIngresada.televisionHogar.nombre}</td>
									<td>
										${solicitudIngresada.televisionHogar.cantCanales} canales, 
										<c:choose>
										...
										<c:choose>
											<c:when test="${solicitudIngresada.televisionHogar.tienePremium}">
		...
		<div class="row">
			<div class="col">
				<a href="index.jsp" class="btn btn-primary">Pagar</a>
			</div>
		</div>
		<footer>
